...
var (
	errEhTest1   = errors.New("error 1")
	errEhEncode  = errors.New("encode error")
	errEhInitial = errors.New("initial encode error")
	failingField = stubs.NewFailingFieldForTest(
		stubs.WithName("test"),
		stubs.WithError(errEhTest1),
	)
...
func TestErrorHandler_EncodeField_WithSuccessfulFallback(t *testing.T) {
	...
	g.Expect(handler.AggregatedError()).To(MatchError(errEhEncode))
...
func TestErrorHandler_EncodeField_WithFailingFallback(t *testing.T) {
	...
	g.Expect(handler.AggregatedError()).To(MatchError(errEhInitial))
...
func TestErrorHandler_EncodeField_WithEarlyFailing(t *testing.T) {
	...
	g.Expect(handler.AggregatedError()).To(MatchError(errEhTest1))
