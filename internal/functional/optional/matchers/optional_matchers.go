...
func bePresentWrongTypeError[T any]() error {
	return fmt.Errorf(
		"BePresent matcher expects an optional.Optional[%T]: %w", *new(T), ErrMatcherWrongType,
	)
}

func beEmptyWrongTypeError[T any]() error {
	return fmt.Errorf(
		"BeEmpty matcher expects an optional.Optional[%T]: %w", *new(T), ErrMatcherWrongType,
	)
}

func haveValueWrongTypeError[T any]() error {
	return fmt.Errorf(
		"HaveValue matcher expects an optional.Optional[%T]: %w", *new(T), ErrMatcherWrongType,
	)
}
