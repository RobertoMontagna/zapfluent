...
func bePresentWrongTypeError[T any]() error {
	return fmt.Errorf(
		"BePresent expects a lazyoptional.LazyOptional[%T]: %w", *new(T), ErrMatcherWrongType,
	)
}

func beEmptyWrongTypeError[T any]() error {
	return fmt.Errorf(
		"BeEmpty matcher expects a lazyoptional.LazyOptional[%T]: %w", *new(T), ErrMatcherWrongType,
	)
}

func haveValueWrongTypeError[T any]() error {
	return fmt.Errorf(
		"HaveValue expects a lazyoptional.LazyOptional[%T]: %w", *new(T), ErrMatcherWrongType,
	)
}
